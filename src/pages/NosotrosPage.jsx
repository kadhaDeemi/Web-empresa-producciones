...
const NosotrosPage = () => {
  return (
    ...
    className="bg-black text-white min-h-screen">
      ...
      <header className="pt-36 pb-16 md:pt-48 md:pb-20 text-center bg-black">
      ...
      <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className='text-center md:text-left'>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 md:mb-8"><span className='text-red-700'>SDC</span> PRODUCCIONES</h2>
            <h4 className='text-lg md:text-xl font-bold mb-4'>SURGE COMO UNA RESPUESTA CREATIVA A LA NECESIDAD DE TRANSFORMAR IDEAS EN EVENTOS MEMORABLES.</h4>
    ...
    <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-white">¿Listo para empezar tu próximo proyecto?</h2>
